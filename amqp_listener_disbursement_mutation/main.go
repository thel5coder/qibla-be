...
import (
	...
	"qibla-backend/db"
	amqpPkg "qibla-backend/helpers/amqp"
	"qibla-backend/helpers/amqpconsumer"
...
var (
	...
	exchange     = flag.String("exchange", amqpPkg.DisbursementMutationExchange, "The exchange we will be binding to")
	exchangeType = flag.String("exchange_type", "direct", "Type of exchange we are binding to | topic | direct| etc..")
	queue        = flag.String("queue", amqpPkg.DisbursementMutation, "Name of the queue that you would like to connect to")
	routingKey   = flag.String("routing_key", amqpPkg.DisbursementMutationDeadLetter, "queue to route messages to")
